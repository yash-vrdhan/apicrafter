...
class StorageManager:
    ...
    def save_request(self, name: str, request_data: RequestData, collection: str = "default") -> None:
    ...
    def load_request(self, name: str, collection: str = "default") -> Optional[RequestData]:
