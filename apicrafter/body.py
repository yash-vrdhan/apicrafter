...
class BodyHandler:
    ...
    @staticmethod
    def prepare_body(body_config: BodyConfig) -> Tuple[Optional[str], Optional[Dict[str, Any]], Dict[str, str]]:
        """
    ...
    @staticmethod
    def parse_body_from_cli(body_string: Optional[str], form_data: Optional[list], raw_data: Optional[str]) -> Optional[BodyConfig]:
        """
    ...
    def _setup_json_body() -> BodyConfig:
        ...
        questionary.print("Enter JSON data (press Ctrl+D or Ctrl+Z when done):", style="fg:cyan")
    ...
    def _setup_raw_body() -> BodyConfig:
        ...
        questionary.print("Enter raw body content (press Ctrl+D or Ctrl+Z when done):", style="fg:cyan")
